...
public class MainActivity extends AppCompatActivity {
    ...
    private void addControl() {
        ...
        tab1.setIndicator("",getResources().getDrawable(R.drawable.outline_feature_search_24));
        tab.addTab(tab1);
        TabHost.TabSpec tab2=tab.newTabSpec("t2");
        tab2.setContent(R.id.tab2);
        tab2.setIndicator("",getResources().getDrawable(R.drawable.outline_format_list_bulleted_24));
        tab.addTab(tab2);
        TabHost.TabSpec tab3=tab.newTabSpec("t3");
        tab3.setContent(R.id.tab3);
        tab3.setIndicator("",getResources().getDrawable(R.drawable.outline_favorite_24));
        tab.addTab(tab3);
